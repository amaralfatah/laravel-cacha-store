...
<head>
    ...
    <style>
        ...
        /* Input styling */
        .value-input, .total-input, .change-input {
            border: none;
                            ...
                            <div class="grid-container main-grid">
                                ...
                                <div class="page-header">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="{{ url('/dashboard') }}" class="btn btn-sm btn-primary d-flex align-items-center">
                                            <i class='bx bx-home-alt me-1'></i> Dashboard
                                        </a>
                                        <button type="button" class="btn btn-sm btn-warning d-flex align-items-center" id="btn-show-pending">
                                            <i class='bx bx-time me-1'></i> Tertunda
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger d-flex align-items-center" id="btn-clear-cart">
                                ...
                                <div class="grid-section">
                                    ...
                                    <div class="grid-section-body">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label class="form-label d-flex align-items-center fw-semibold text-uppercase small mb-1"
                                                       for="pos_barcode">
                                ...
                                <div class="grid-section d-flex flex-column">
                                    ...
                                    <div class="table-container flex-grow-1">
                                        ...
                                        <div id="empty-cart-message" class="empty-cart">
                                            ...
                                            <p class="text-muted mb-3">Silakan scan barcode atau cari produk untuk memulai transaksi</p>
                        ...
                        <div class="col-lg-4 col-md-12 pos-bill-column">
                            <div class="bill-grid">
                                ...
                                <div class="action-buttons mt-4">
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <button type="button" class="btn btn-outline-secondary w-100 d-flex align-items-center justify-content-center fw-semibold" id="btn-pending">
                                                <i class='bx bx-time-five me-1'></i> Pending
                                            </button>
                                        </div>
                                        <div class="col-6">
                                            <button type="button" class="btn btn-primary w-100 d-flex align-items-center justify-content-center fw-semibold" id="btn-save">
