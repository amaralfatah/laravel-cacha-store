            ...
            <div class="card-body">
                <form action="{{ route('user.store.update') }}" method="POST" enctype="multipart/form-data" id="storeForm">
                    ...
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        @if($store->logo)
                            <img src="{{ asset($store->logo) }}" alt="store-logo" class="d-block rounded" height="100" width="100" id="previewImage"/>
                        @else
                            <div class="d-block rounded bg-light d-flex align-items-center justify-content-center" id="noImagePreview" style="height: 100px; width: 100px;">
                                <i class='bx bx-store text-secondary' style="font-size: 2rem;"></i>
                            </div>
                            <img src="" alt="store-logo" class="d-block rounded d-none" height="100" width="100" id="previewImage"/>
                        @endif
