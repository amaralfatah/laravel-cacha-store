            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <div class="d-flex flex-column flex-md-row gap-4">
                            ...
                            @if ($product->images->where('is_primary', true)->first())
                                <div class="flex-shrink-0 text-center mb-3 mb-md-0">
                                    <img src="{{ asset('storage/' . $product->images->where('is_primary', true)->first()->image_path) }}"
                                        alt="{{ $product->name }}" class="rounded shadow-sm object-fit-cover"
                                        style="width: 120px; height: 120px;" />
                                </div>
                            @else
                                <div class="flex-shrink-0 rounded bg-label-primary d-flex align-items-center justify-content-center mb-3 mb-md-0 shadow-sm"
                                    style="width: 120px; height: 120px;">
                        ...
                        <!-- Informasi Utama Produk - Disederhanakan -->
                        <div class="flex-grow-1">
                            ...
                            <!-- Badge Status - Dipindahkan ke atas untuk visibilitas lebih baik -->
                            <div class="mb-3 d-flex flex-wrap gap-2">
                                <span
                                    class="badge bg-label-{{ $product->is_active ? 'success' : 'danger' }} rounded-pill px-2 py-1">
                            ...
                            <!-- Informasi Produk Disederhanakan - Hanya detail penting -->
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                ...
                                                <div>
                                                    <strong>{{ number_format($defaultUnit?->stock ?? 0) }}
                                                        {{ $defaultUnit?->unit->code }}</strong>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div>
                                                ...
                                                <div>
                                                    <strong>Rp
                                                        {{ number_format($defaultUnit?->selling_price ?? 0) }}</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="tab-pane fade show active" id="tab-units" role="tabpanel">
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-transparent d-flex justify-content-between align-items-center py-3">
                        ...
                        <a href="{{ route('products.units.create', $product) }}" class="btn btn-sm btn-primary">Tambah
                        </a>
                    </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow">
                                                    <div class="modal-header border-0">
                                                        <h5 class="modal-title">Adjust Stock - {{ $unit->unit->name }}
                                                        </h5>
                                                    ...
                                                    <form action="{{ route('stock.adjustments.store') }}" method="POST">
                                                        ...
                                                        <div class="modal-footer border-0">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-sm btn-primary px-3">Save
                                                            </button>
                                                        </div>
                                                    </form>
                                                </div>
                                    ...
                                    @forelse($product->productUnits->flatMap->prices->sortBy('min_quantity') as $price)
                                        <tr>
                                            ...
                                            <td class="px-4 py-3">
                                                @php
                                                    $margin =
                                                        (($price->price - $price->productUnit->purchase_price) /
                                                            $price->productUnit->purchase_price) *
                                                        100;
                                                @endphp
                                                <span
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    @forelse($product->transactionItems as $item)
                                        <tr>
                                            <td class="px-4 py-3">
                                                {{ $item->transaction->invoice_date->format('d/m/Y H:i') }}</td>
                    ...
                    <div class="card-body text-center">
                        @if ($product->barcode_image && Storage::disk('public')->exists($product->barcode_image))
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="{{ Storage::url($product->barcode_image) }}" class="btn btn-label-primary"
