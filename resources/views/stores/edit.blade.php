...
@push('styles')
    ...
    <style>
        /* Minimal custom styles yang tidak ada di Bootstrap */
        .upload-button {
            width: 32px;
            height: 32px;
        }
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge {{ $store->is_active ? 'bg-success' : 'bg-danger' }} rounded-pill px-3">
                        ...
                        <form action="{{ route('stores.update', $store->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="text-center mb-4">
                                <div class="position-relative d-inline-block">
                                    <div class="border rounded-circle p-2 bg-light">
                                        ...
                                        @else
                                            <div class="rounded-circle bg-white d-flex align-items-center justify-content-center store-logo">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        <label for="code" class="form-label small fw-semibold text-secondary">Store Code</label>
                                    ...
                                    <div class="mb-4">
                                        <label for="name" class="form-label small fw-semibold text-secondary">Store Name</label>
                                        <div class="input-group">
                                        <span class="input-group-text bg-light">
            ...
            if (e.target.files && e.target.files[0]) {
                ...
                reader.onload = function(e) {
                    const preview = document.querySelector('img.rounded-circle') ||
                        document.querySelector('.rounded-circle.bg-white');
