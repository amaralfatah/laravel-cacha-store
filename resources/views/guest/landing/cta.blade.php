                ...
                <div class="mt-4">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="#" class="bg-white p-2 rounded-circle">
                            <img src="{{asset('images/logo-snack-circle-light.png')}}" alt="Tokopedia" width="40"
                                 height="40">
                        </a>
                        <a href="#" class="bg-white p-2 rounded-circle">
                            <img src="{{asset('images/logo-snack-circle-light.png')}}" alt="Shopee" width="40" height="40">
                        </a>
                        <a href="#" class="bg-white p-2 rounded-circle">
                            <img src="{{asset('images/logo-snack-circle-light.png')}}" alt="Bukalapak" width="40"
                                 height="40">
                        </a>
                        <a href="#" class="bg-white p-2 rounded-circle">
                            <img src="{{asset('images/logo-snack-circle-light.png')}}" alt="Lazada" width="40" height="40">
                        </a>
                    </div>
                </div>
            </div>
